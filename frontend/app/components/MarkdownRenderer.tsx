              ...
              >
                <div className="code-header px-4 py-2 text-xs bg-gray-800 text-gray-200 flex items-center justify-between">
                  <span className="font-medium">
                    {mappedLanguage ? mappedLanguage.toUpperCase() : "TEXT"}
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded bg-gray-700">
                    CODE
                  </span>
                </div>
                <Suspense
                  fallback={
                    <pre className="text-sm p-4 bg-gray-900 text-gray-200 rounded-b-md">
                      {code}
                    </pre>
                  }
                >
